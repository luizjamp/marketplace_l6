    ...
    <div class="row">
        ...
        <div class="col-12">
            @if($cart)
                <table class="table table-striped">
                    ...
                    @foreach($cart as $c)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('cart.remove',['slug'=>$c['slug']])}}" class="btn-sm btn-danger">REMOVER</a>
                            </td>
                ...
                <hr>
                <div class="col-md-12">
                    <a href="{{route('checkout.index')}}" class="btn-lg btn-success float-right">Concluir Compra</a>
